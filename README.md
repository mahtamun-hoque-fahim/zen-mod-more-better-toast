...
- **Safe minimum offset** — no longer clips to the screen edge when `zen.theme.content-element-separation = 0` (fixes [lenzfliker/zen-mods#2](https://github.com/lenzfliker/zen-mods/issues/2))
